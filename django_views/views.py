...
# check methods
    ...
    json_pretty = json.dumps(df.to_json(trans1.show_transaction_story_df_customer("Mary" , df)))
    #json_pretty2 =  
    return HttpResponse(json_pretty, content_type = "application/json") # return the biggest balance
